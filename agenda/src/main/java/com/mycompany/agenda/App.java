...
import com.mycompany.agenda.RootLayoutControlador;
import com.mycompany.agenda.PersonOverviewControlador;
import com.mycompany.agenda.PersonEditDialogControlador;
import com.mycompany.agenda.BirthdayStatisticsControlador;
import com.mycompany.agenda.modelo.persona;
...
public class App extends Application {
    ...
    public void initRootLayout() {
        try {
            ...
            loader.setLocation(App.class.getResource("/com/mycompany/agenda/Root.fxml"));
    ...
    public boolean showPersonEditDialog(persona person) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(App.class.getResource("/com/mycompany/agenda/PersonEdit.fxml"));
    ...
    public void showBirthdayStatistics() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(App.class.getResource("/com/mycompany/agenda/CumpleañosCuadro.fxml"));
            AnchorPane page = (AnchorPane) loader.load();
            Stage dialogStage = new Stage();
